		...
		<section className='about-page'>
			<section className='collaborators'>
				...
				<p className='app-summary'>Gamenight was born out of a love for, well, game nights. We were motivated by a desire to have a simple interface
					for keeping track of the competition. Part time capsule/memory log, part scoreboard, we built gamenight for anyone
					who enjoys getting together with loved ones to battle it out for bragging rights. Keep track of overall wins to save time arguing over who is the best. This project was completed as part of Turing
